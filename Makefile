...
RTOS_SOURCE_DIR= RtosV611/Source
DEMO_INCLUDE_DIR=RtosV611/Common/include
...
# linker script
ifeq ($(RAM_FLASH), 1)
	LD_SCRIPT = Setup/stm32_ram.ld
else
	LD_SCRIPT = Setup/stm32_rom.ld
endif
...
LIBS =
#piContacts.a MemoryOperations.a libm.a
#funAdd.a 
